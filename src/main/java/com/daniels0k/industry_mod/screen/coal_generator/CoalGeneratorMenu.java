...
public class CoalGeneratorMenu extends AbstractContainerMenu {
    ...
    public CoalGeneratorMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.COAL_GENERATOR_MENU.get(), containerId);
        this.blockEntity = (CoalGeneratorBlockEntity) blockEntity;
        this.level = inv.player.level();
        addPlayerInventory(inv);
        addPlayerHotbar(inv);
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory, 0, 80, 36));
